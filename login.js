export class Login {
    ...
    static login = (callback_ok, callback_naook, config = null) => {
        ...
        this.estilocss =
            ...
            ".logoLogin {display: flex;justify-content: center;align-items: center;width: 50%;background-color: #ccc;padding: 10px;border-radius: 0px 10px 10px 0px;box-sizing: inherit;}" +
            ".logoLogin img {width: 90%;box-sizing: inherit;}" +
            ".elementosLogin {display: flex;justify-content: center;align-items: flex-start;flex-direction: column;width: 50%;background-color: #ccc;padding: 10px;border-radius: 10px 0px 0px 10px;box-sizing: inherit;}" +
